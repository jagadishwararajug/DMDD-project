...
Else
    ...
    Vaccine_Storage_Name VARCHAR(15) not null,
    Address VARCHAR(30) not null,
    Zipcode NUMBER(10) not null,
    CONSTRAINT VAC_STORAGE_ID_PK PRIMARY KEY(Vaccine_Storage_Facility_Id)
    )';
     DBMS_OUTPUT.PUT_LINE('TABLE VACCINE_STORAGE CREATED SUCCESSFULLY');
     DBMS_OUTPUT.PUT_LINE('-------------------------------------------------------------------------------------------------------------------');      
end if;
...
-- create table VACCINE_CENTER if doesn't exists
    ...
    Else
        ...
        Vaccine_Center_Name VARCHAR2(30) NOT NULL,
        Vaccine_Center_Address VARCHAR2(50) NOT NULL,
...
-- create table STAFF if doesn't exists
    ...
    Else
        ...
        Staff_Id NUMBER GENERATED ALWAYS as IDENTITY(START with 401 INCREMENT by 1),
...
-- create table IMMUNIZATION_DETAILS if doesn't exists
    ...
    Else
      ...
      Vaccine_Id number not null,
      constraint Vaccine_Id_Immunization_fk foreign key (Vaccine_Id) references VACCINE_DETAILS(Vaccine_Id),      
...
-- create table APPOINTMENT if doesn't exists
    ...
    Vaccine_Batch_Info_Id number GENERATED ALWAYS as IDENTITY(START with 1201 INCREMENT by 1),
