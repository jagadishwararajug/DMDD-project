...
BEGIN
        DBMS_OUTPUT.PUT_LINE('-------------------------------------------------------------------------------------------------------------------');
        INSERT INTO IMMUNIZATION_DETAILS(Vaccine_Brand, Dose_date, Vaccination_Status, User_Id, Vaccine_Id) VALUES (Vaccine_Brand, Dose_date, Vaccination_Status, User_Id, Vaccine_Id); 
...
BEGIN
        DBMS_OUTPUT.PUT_LINE('-------------------------------------------------------------------------------------------------------------------');
        INSERT INTO USER_MEDICAL_RECORD(User_Id, Respiratory_distress, Allergy, High_blood_pressure, Fever, Date_of_Appointment,  Comments) VALUES (User_Id, Respiratory_distress, Allergy, High_blood_pressure, Fever, Date_of_Appointment,  Comments); 
